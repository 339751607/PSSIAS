	...
	error : function(v,elm,useTitle) {
		...
		if(typeof error == 'string') {
	    	...
	    	for (var i = 0; i < v.length; i++) {   
                    if (v.charCodeAt(i) >= 0x4e00 && v.charCodeAt(i) <= 0x9fa5){    
                        len += 2;   
                    }else if ((v.charCodeAt(i) >= 0xff00 && v.charCodeAt(i) <= 0xffef)   
                            || (v.charCodeAt(i) >= 0x3000 && v.charCodeAt(i) <= 0x303f)){   
...
Validation.addAllThese([
	 ...
	 * Example: 
	 */
	['int-diy',function(v,elm,args,metadata) {
		 var len=0; 
	    	for (var i = 0; i < v.length; i++) {   
                    if (v.charCodeAt(i) >= 0x4e00 && v.charCodeAt(i) <= 0x9fa5){    
                        len += 2;   
	 ...
	 * Example: 
	 */
	['diy-date',function(v,elm,args,metadata) {
		return (parseInt(v)>= parseInt(args[0])&&parseInt(v)<= parseInt(args[1]))
	},{depends : ['validate-number']}],
	/*
