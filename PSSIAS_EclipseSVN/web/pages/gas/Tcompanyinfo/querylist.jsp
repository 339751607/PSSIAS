...
<div class="queryPanel">
    <s:form action="/pages/gas/Tcompanyinfogas/querylist.do"  theme="simple"  name ="TcompanyinfoForms" style="display: inline;" method="post">
...
<!--		                           <input value="${pageRequest.filters.modTime}"  name="s_modTime"  />-->
		           ...
		           <tr class="crosscolor_tr">
                    ...
                    <tr class="crosscolor_tr">
			              ...
			              <td>
				                <s:select name="s_burcode" id="country"  value=""  onchange="getPcs();" list="provMap" listKey="key" headerKey=""  listValue="value" theme="simple" label="省市"  emptyOption="false" ></s:select>
		                  </td>
                          <td class="crosscolor_td">
			                      <%=Tcompanyinfo.ALIAS_STACODE%>
		                  </td>
			              <td id="pcstd">
								<select id="province" name="s_stacode"  ></select>
		                  </td>
                   </tr>
                   
		           <tr>
			              <td class="tb_bottom" colspan="4">
			                       <input type="submit"  value="查询" onclick="getReferenceForm(this).action='${ctx}/pages/gas/Tcompanyinfogas/querylist.do'"/>
...
<ec:table items='page.result' var="item" method="get"
	...
	action="${ctx}/pages/gas/Tcompanyinfogas/querylist.do" autoIncludeParameters="true">
	<ec:row>
