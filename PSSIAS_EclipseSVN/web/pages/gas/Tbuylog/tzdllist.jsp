...
<ec:table items='page.result' var="item" method="get"
	...
	action="${ctx}/pages/gas/Tbuylog/tzdllist.do" autoIncludeParameters="true">
	<ec:row>
             ...
             <ec:column property="操作" title="操作" sortable="false" viewsAllowed="html">
            	 <a href="#"  onclick="javascript:openTz('${item.id}','<mytag:params includes="ec*,s*" type="queryStringUtf"/>');return false;"  >查看</a>
			</ec:column>
	</ec:row>
</ec:table>
</body>
