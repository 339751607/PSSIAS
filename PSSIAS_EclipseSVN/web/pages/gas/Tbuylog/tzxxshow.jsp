...
<s:form action="/pages/gas/Tbuylog/list.do" method="get" theme="simple">
	...
	<table width="100%" border="1" bordercolor="#7c8ca7" align="center"  cellPadding="0" cellSpacing="0" class="tb_all">
		           ...
		           <tr class="crosscolor_tr">
			              ...
			              <td>
			              <a onclick="javascript:openTz('${model.cpcode}')" style="color: #0000FF; text-decoration: underline;">
...
<script>
  function openTz(ID)
  {
   var ReturnValue = window.showModalDialog("${ctx}/pages/gas/Tcompanyinfogas/tzxxcpshow.do?cpcode="+ID,"prompt_tz","dialogHeight:300px;dialogWidth:850px;scroll:on;center:yes");
  }
</script>
