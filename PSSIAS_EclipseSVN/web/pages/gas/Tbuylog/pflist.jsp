...
<div class="queryPanel">
    <s:form action="/pages/gas/Tbuylog/pflist.do"  theme="simple" style="display: inline;" method="post">
	   <table width="100%" border="1" bordercolor="#7c8ca7" align="center"  cellPadding="0" cellSpacing="0" class="tb_all">
	               <tr>
			              <td class="tb_title" colspan="4">频繁购油信息查询</td>
		           </tr>
		           ...
		           <tr class="tr_tb">
			              ...
			              <td>
		                           <input value="${pageRequest.filters.gycs}"  name="s_gycs"   class="validate-number " required="false" />
		                  </td>
...
<ec:table items='page.result' var="item" method="get"
	...
	action="${ctx}/pages/gas/Tbuylog/pflist.do" autoIncludeParameters="true">
	<ec:row>
             ...
             <ec:column property="操作" title="操作" sortable="false" viewsAllowed="html">
				<a href="${ctx}/pages/gas/Tbuylog/rygyshow.do?idcode=${item.idCode}&<mytag:params includes="ec*,s*" type="queryStringUtf"/>">查看</a>&nbsp;&nbsp;&nbsp;
			</ec:column>
	</ec:row>
</ec:table>
