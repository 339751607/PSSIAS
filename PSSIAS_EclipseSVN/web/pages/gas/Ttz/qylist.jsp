...
<div class="queryPanel">
    <s:form action="/pages/gas/Ttz/qylist.do"  theme="simple" style="display: inline;" method="post">
	   <table width="100%" border="1" bordercolor="#7c8ca7" align="center" 	cellPadding="0" cellSpacing="0" class="tb_all">
		           ...
		           <tr>
			              <td class="tb_bottom" colspan="4">
			                       <input type="submit"  value="查询" onclick="getReferenceForm(this).action='${ctx}/pages/gas/Ttz/qylist.do'"/>
			              </td>
		           </tr>
	    </table>
    </s:form>
...
<ec:table items='page.result' var="item" method="get"
	...
	action="${ctx}/pages/gas/Ttz/qylist.do" autoIncludeParameters="true">
	<ec:row>
