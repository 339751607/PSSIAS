                   ...
                   <tr>
						  <td colspan="4" class="tb_bottom">
						  	<c:if test='${model.hzflag ==1}'>
						           <input type="button" value="回执列表" onclick="javascript:openhzxx(${model.id});"/>
						         </c:if>  <input type="button" value="返回" onclick="window.location='${ctx}/pages/gas/Ttz/list.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>'"/>
	                      </td>
	               </tr>
	</table>	
</s:form>
