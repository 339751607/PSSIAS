...
<s:form action="/pages/gas/Tempworklog/update.do"  theme="simple"  method="post">
	<table width="100%" border="1" bordercolor="#7c8ca7" align="center"  cellPadding="0" cellSpacing="0" class="tb_all">
	    <input type="hidden" name="returnUrl" value="!/pages/gas/Tempworklog/list.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>" />
	        <tr>
