...
<head>
	...
	<base href="<%=basePath%>">
	<title><%=TpersonAlarm.TABLE_ALIAS%>详细</title>
</head>
	...
	<table width="100%" border="1" bordercolor="#7c8ca7" align="center"   cellPadding="0" cellSpacing="0" class="tb_all">
		 <tr class="crosscolor_tr">
		           ...
		           <tr class="crosscolor_tr">
			              ...
			              <td>
		                   <a onclick="javascript:tzalarmmess('${model.cpcode}')" style="color: #0000FF; text-decoration: underline;">
...
<script>
  function tzalarmmess(ID)
  {
   var sReturn = window.showModalDialog("${ctx}/pages/gas/Tcompanyinfogas/tzxxcpshow.do?cpcode="+ID,"prompt_mes_pop","dialogHeight:300px;dialogWidth:1050px;scroll:on;center:yes");
