...
<head>
	...
	<base href="<%=basePath%>">
	<title><%=TcpinfoYl.TABLE_ALIAS%>新增</title>
</head>
<body>
<%@ include file="/commons/messages.jsp" %>

<s:form action="/pages/ylcs/TcpinfoYl/save.do" theme="simple"  method="post">
...
<!-- ONGL access static field: @package.class@field or @vs@field -->
                   ...
                   <tr class="crosscolor_tr">
                         <td class="crosscolor_td">
			              ...
			              <td>
			              		   <mytag:select dictName="ssfj" styleClass="required" name="policeunit"/>
		                           <font color="red">*</font>
		                  </td>
		                  <td class="crosscolor_td">
                   ...
                   <tr class="crosscolor_tr">
			              ...
			              <td>
			              		   <mytag:select dictName="ssfj" styleClass="required" name="scbackupunit" />
		                           <font color="red">*</font>
		                  </td>
		                                            <td class="crosscolor_td">
                   ...
                   <tr class="crosscolor_tr">
			              ...
			              <td>
			              		  <mytag:select dictName="ssfj" styleClass="required" name="fjcode" />
		                          <font color="red">*</font>
		                  </td>
		                  <td class="crosscolor_td">
		           ...
		           <tr class="crosscolor_tr">
			              ...
			              <td>
			              		   <mytag:select dictName="t_dic_cptype" styleClass="required" name="thcode" />
		                           <font color="red">*</font>
		                  </td>
		                  <td class="crosscolor_td">
			              ...
			              <td>
			              		   <mytag:select dictName="T_DIC_ZAJB" styleClass="required" name="zajb"/>
		                           <font color="red">*</font>
		                  </td>
                   </tr>
                   <tr class="crosscolor_tr">
			              ...
			              <td>
			              		   <mytag:select dictName="T_DIC_CSXJ" name="csxj" />
		                  </td>
		                   <td class="crosscolor_td">
                   ...
                   <tr class="crosscolor_tr">
                    ...
                    <tr class="crosscolor_tr">
			              ...
			              <td>
			              		   <mytag:select dictName="T_DIC_YLCSSTATE" name="state" styleClass="required"/><font color="red">*</font>
		                  </td>
		                  <td class="crosscolor_td">
			                      <%=TcpinfoYl.ALIAS_POLICELEVELCODE%>
		                  </td>
			              <td>
			              		   <mytag:select dictName="T_DIC_ZADJ" name="policelevelcode" styleClass="required"></mytag:select>
		                  </td>
                   ...
                   <tr class="crosscolor_tr">
			              ...
			              <td>
			              	<mytag:select dictName="T_DIC_UNITTYPE" styleClass="required" name="dwlx"/>
							<font color="red">*</font>
		                  </td>
                          <td class="crosscolor_td">
