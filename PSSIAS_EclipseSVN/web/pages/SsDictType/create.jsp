...
<head>
	...
	<base href="<%=basePath%>">
	<title><%=SsDictType.TABLE_ALIAS%>新增</title>
</head>
<body onload="quickSelectInit()">
<%@ include file="/commons/messages.jsp" %>

<s:form action="/pages/SsDictType/save.do" theme="simple"  method="post">
	    ...
	    <input type="hidden" name="returnUrl" value="!/pages/SsDictType/list.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>" />
	       <tr>
	         ...
	         <tr class="crosscolor_tr">
			              ...
			              <td>
		                           <s:textfield label="%{@vs@ALIAS_DICTTYPEID}" key="dicttypeids" value="%{model.dicttypeid}" cssClass="required max-length-128" required="false" />
		                  </td>
                          <td class="crosscolor_td">
