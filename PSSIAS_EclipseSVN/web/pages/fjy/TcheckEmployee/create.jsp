...
<head>
	...
	<base href="<%=basePath%>">
	<title><%=TcheckEmployee.TABLE_ALIAS%>注册</title>
</head>
<body onload="quickSelectInit()" >
<%@ include file="/commons/messages.jsp" %>
<%@ include file="/commons/selectDept.jsp" %>
<s:form action="/pages/fjy/TcheckEmployee/save.do" theme="simple"    name="inputForm"  method="post">
	    ...
	    <input type="hidden" name="returnUrl" value="!/pages/fjy/TcheckEmployee/list.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>" />
	       <tr>
               ...
               <tr class="crosscolor_tr">
			              ...
			              <td>
						           <mytag:select property="%{model.emptype}"   styleClass="required validate-selection"  name="emptype"  onchange="showorhidden()" notEmpty="false"  dictName="D_empType"/>
		                  </td>
                   </tr>
		           <tr class="crosscolor_tr">
                          <td class="crosscolor_td">
