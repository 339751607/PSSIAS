...
<body>
<form name="editForm"   action="${ctx}/pages/fjy/Tfeijiuwupin/editPict.do" enctype="multipart/form-data" method="post">
...
function SendFile()
{
   ...
   var   FILEID = document.getElementById("FILEID").value;   
	...
	document.editForm.action="${ctx}/pages/fjy/Tfeijiuwupin/editPict.do?FILEID="+FILEID;
