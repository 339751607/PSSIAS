...
<s:form action="/pages/fjy/Tfeijiuwupin/listAll.do" method="get" theme="simple">
...
<mytag:tab id="orgInfo"  width="100%" height="100%"   >
     <mytag:tabContent url="${ctx}/pages/fjy/TfeijiuwupinKeyi/listDisplay.do"     param="s_wupinxh"  paramValue="${model.wupinxh}"   frameBorder="0" tabType="frame" scrolling="auto" title="附加信息"/>
</mytag:tab>
</body>
...
<script>
    ...
    function doBack(){
    	var url="";
    	url =  "${ctx}/pages/fjy/Tfeijiuwupin/listAll.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>";
    	location.href = url;
    }
</script>