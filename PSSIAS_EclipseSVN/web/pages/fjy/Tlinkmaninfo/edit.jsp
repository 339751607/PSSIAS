...
<head>
	...
	<base href="<%=basePath%>">
	<title><%=Tlinkmaninfo.TABLE_ALIAS%>编辑</title>
</head>

<body onload="quickSelectInit()" >
<%@ include file="/commons/messages.jsp" %>

<s:form action="/pages/fjy/Tlinkmaninfo/update.do"  theme="simple"  method="post">
	<table cellpadding="0" cellspacing="0" border="1" class="tb_all">
	    <input type="hidden" name="returnUrl" value="!/pages/fjy/Tlinkmaninfo/list.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>" />
	       <s:hidden name="empcode" value="%{model.empcode}"></s:hidden>
	       <s:hidden id="linkmanid" name="linkmanid" />
	        <tr>
				      <td colspan="4" class="tb_title"> 
							<%=Tlinkmaninfo.TABLE_ALIAS%>编辑
				     </td>
		    </tr>
	            <tr class="crosscolor_tr">
		           ...
		           <tr class="crosscolor_tr">
			              ...
			              <td>
	                               <s:textfield label="%{@vs@ALIAS_IDCODE}" key="idcode"  onblur="javascript:showBirthday();"  value="%{model.idcode}"  cssClass=" max-length-18 validate-id-number" required="false" />
		                  </td>
	       ...
	       <tr >
	        <tr >
					 <td colspan="4" class="tb_bottom">
	                        ...
	                        <input type="button" value="返回" onclick="window.location='${ctx}/pages/fjy/Tlinkmaninfo/list.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>'"/>   
					 </td>
			</tr>
	</table>
</s:form>
