...
<s:form action="/pages/fjy/TfjycpCheck/save.do" theme="simple"  method="post">
	<table cellpadding="0" cellspacing="0" border="1" class="tb_all">
	    <input type="hidden" name="returnUrl" value="!/pages/fjy/TfjycpCheck/listUser.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>&t_checktype=2" />
	...
	<tbody class="tableBody" id="jcjg">
	       ...
	       <tr >
				<td colspan="4" class="tb_bottom">
	                      ...
	                      <input type="button" value="返回" onclick="window.location='${ctx}/pages/fjy/TfjycpCheck/listUser.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>&t_checktype=2'"/>
			    </td>
	        </tr>
	</table>
</s:form>
