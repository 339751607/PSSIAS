...
<div class="queryPanel">
    ...
    <input type="hidden" name="t_checktype" value="1"/>
    <input type="hidden" name="t_emptype" value="01"/>
...
<ec:table items='page.result' var="item" method="get"
	...
	<ec:row>
		...
		<ec:column property="操作" title="操作" sortable="false" width="10%" viewsAllowed="html">
			<a href="${ctx}/pages/fjy/TfjycpCheck/userShow.do?id=${item.id}&t_checktype=1&<mytag:params includes="ec*,s*" type="queryStringUtf"/>">查看</a>&nbsp;&nbsp;&nbsp;
		</ec:column>
	</ec:row>
</ec:table>
