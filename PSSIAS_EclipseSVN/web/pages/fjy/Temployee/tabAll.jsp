		           ...
		           <tr class="crosscolor_tr">
		                  ...
		                  <td rowspan="12" width="18%" align="center" >
						      <%if(picCount != null && picCount.equals("1")) { %>
					             <a  href="#"> <img src='${ctx}/pages/fjy/Temployee/showPic.do?xh=<s:property value="%{model.empcode}" />'  height="126" alt="" width="102" border="0" name="photo"> </a>	
					           <% } else {%>
...
<mytag:tab id="orgInfo"  width="100%" height="100%"   >
     <mytag:tabContent url="${ctx}/pages/fjy/Tlinkmaninfo/list.do"     param="s_empcode"  paramValue="${model.empcode}"   frameBorder="0" tabType="frame" scrolling="auto" title="应急联系人"/>
	 <mytag:tabContent url="${ctx}/pages/fjy/Tempworklog/list.do"  selected="true"   param="s_empcode"  paramValue="${model.empcode}"   frameBorder="0" tabType="frame" scrolling="auto" title="从业记录"/>
</mytag:tab>
</body>
...
<script>
    ...
    function doBack(){
    	var url="";
    	url =  "${ctx}/pages/fjy/Temployee/listAll.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>";
    	location.href = url;
    }
</script>