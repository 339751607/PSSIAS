...
<html>
	...
	<body onload="quickSelectInit()">
		...
		<s:form action="/pages/fjy/Temployee/update.do" theme="simple"
			...
			<table cellpadding="0" cellspacing="0" border="1" class="tb_all">
				<input type="hidden" name="returnUrl"
					value="!/pages/fjy/Temployee/list.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>" />
				<input type="hidden" name="editReturnUrl"
					value="!/pages/fjy/Temployee/edit.do?empcode=<%=empcode%>&userid=<%=userid%>&" />
				<tr>
				...
				<tr class="crosscolor_tr">
					...
					<td rowspan="7" width="18%" align="center">
				...
				<tr class="crosscolor_tr">
					<td class="crosscolor_td" colspan="5" style="text-align: left;">
						<input type="checkbox" id="checkOpr" onclick="isDisplay();" class="formRadio"/>
						操作员信息
					</td>
				</tr>
				<tr id="show0a" style="display: none" class="crosscolor_tr">
					...
					<td>
						...
						<s:textfield key="updateusername" id="usernameid"  value="%{model.username}"
				...
				<tr id="show0c" style="display: none" class="crosscolor_tr">
					...
					<td colspan="4">
						<s:radio value="%{model.userrole}" listKey="roleid" cssClass="formRadio"
				...
				<tr>
					<td colspan="5" class="tb_bottom">
						...
						<input type="button" value="返回"
							onclick="window.location='${ctx}/pages/fjy/Temployee/list.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>'" />
					</td>
				</tr>
			</table>
		</s:form>
...
<!-- Begin  -->  	
    ...
    function isTrueName(s) {
		var patrn = /^[a-zA-Z][a-zA-Z0-9_]{5,30}$/;
		if (!patrn.exec(s))
			return false
		return true
	}
