...
<div class="queryPanel">
 <table cellpadding="0" cellspacing="0" border="1" class="tb_all">
	               <tr>
			              <td class="tb_title" colspan="4"><%=Temployee.TABLE_ALIAS%>查询结果列表</td>
		           </tr>
 </table>
 </div>
 <!--  -->
<ec:table items='page.result' var="item" method="get"
	...
	<ec:exportXls fileName="Temployee.xls" tooltip="输出Excel文件"/> 
    <ec:exportCsv fileName="Temployee.txt" tooltip="输出CSV文件" delimiter=","/> 
	<ec:row>
		                    ...
		                    --%><ec:column property="personid"  alias="PERSON_ID"  title="<%=Temployee.ALIAS_PERSONID%>" escapeAutoFormat="true" />	
