...
<s:form action="/pages/fjy/Temployee/saveAll.do" theme="simple"  enctype="multipart/form-data"  name="inputForm" method="post">
<s:hidden key="npcodehidden"  />
<s:hidden key="nativeplacehidden"  />
	<table cellpadding="0" cellspacing="0" border="1" class="tb_all">
	    <input type="hidden" name="returnUrl" value="!/pages/fjy/Temployee/listAll.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>" />
	       <tr>
				<td colspan="4" class="tb_title"> 
	              ...
	              <tr class="crosscolor_tr">
		           ...
		           <tr class="crosscolor_tr">
					...
					<td>
						<mytag:select property="position"
                   ...
                   <tr class="crosscolor_tr">     
			              ...
			              <td>
		                           ...
		                           <s:textfield   key="deptname" value="%{model.deptname}"  cssClass="required max-length-100" required="false" />
					...
					<td class="crosscolor_td" colspan="4" style="text-align: left;">
						<input type="checkbox" id="checkOpr" 
							onclick="isDisplay();" />
						操作员信息
					</td>
				</tr>
				<tr id="show0a" style="display:none" class="crosscolor_tr">
					...
					<td>
						<s:textfield label="%{@vs@ALIAS_USERNAME}" key="username"
				...
				<tr id="show0b" style="display:none"  class="crosscolor_tr">
					...
					<td>
						<s:textfield label="%{@vs@ALIAS_PASSWORD}" key="password2"
							value="%{model.password2}" cssClass="required max-length-50"
							required="false" />
					</td>
				</tr>
	       ...
	       <tr >
				<td colspan="4" class="tb_bottom">
	                        ...
	                        <input type="button" value="返回" onclick="window.location='${ctx}/pages/fjy/Temployee/listAll.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>'"/>
			    </td>
	        </tr>
	</table>
</s:form>
