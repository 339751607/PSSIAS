...
<mytag:tab id="orgInfo"  width="100%" height="100%"   >
     <mytag:tabContent url="${ctx}/pages/fjy/TcpCheckInfo/list.do"     param="s_checkid"  paramValue="<%=checkid%>"   frameBorder="0" tabType="frame" scrolling="auto" title="检查信息"/>
...
<script>
    ...
    function doBack(){
    	var url="";
    	url =  "${ctx}/pages/fjy/TcpCheck/list.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>";
    	location.href = url;
    }
</script>