...
String id =	(String)request.getAttribute("telinfoids");
%>
<html>
<head>
	<%@ include file="/commons/meta.jsp" %>
	<base href="<%=basePath%>">
	<title><%=Telxs.TABLE_ALIAS%>新增</title>
</head>
<body onload="quickSelectInit()" >
<%@ include file="/commons/messages.jsp" %>

<s:form action="/pages/fjy/Telxs/save.do" theme="simple"  method="post">
	<table cellpadding="0" cellspacing="0" border="1" class="tb_all">
	    ...
	    <input type="hidden" name=telinfoids value="<%=id%>" id="id"/>
	       <tr>
				<td colspan="4" class="tb_title"> 
							<%=Telxs.TABLE_ALIAS%>新增
			    </td>
		   </tr>
	<%@ include file="form_include.jsp" %>
	       <tr >
				<td colspan="4" class="tb_bottom">
	                        ...
	                        <input type="button" value="返回" onclick="javascript:window.parent.history.back() "/>
			    </td>
	        </tr>
	</table>
</s:form>
