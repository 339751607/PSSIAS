...
<mytag:tab id="orgInfo"  width="100%" height="100%"   >
	 ...
	 <mytag:tabContent url="${ctx}/pages/fjy/Telxs/xslist.do"  selected="true"   param="telinfoids"  paramValue="<%=telinfoids%>"   frameBorder="0" tabType="frame" scrolling="auto" title="销售信息"/>
</mytag:tab>
</body>
</html>
<script>
