...
<s:form action="/pages/fjy/TelInfoView/listAll.do" method="get" theme="simple">
		          ...
		          <tr class="crosscolor_tr">
                   ...
                   <tr>
						  <td colspan="4" class="tb_bottom">
						           <input type="button" value="返回" onclick="window.location='${ctx}/pages/fjy/TelInfoView/listAll.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>'"/>
	                      </td>
	               </tr>
	               <% } %>
	</table>	
