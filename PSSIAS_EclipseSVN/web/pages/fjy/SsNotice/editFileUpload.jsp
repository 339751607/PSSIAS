...
<body >	
<form id="editForm" name="editForm"  action="${ctx}/pages/fjy/SsNotice/editFile.do" enctype="multipart/form-data" action="" method="post">
...
function SendFile()
{
   ...
   var   FILEID = document.getElementById("FILEID").value; 
	...
	document.editForm.action="${ctx}/pages/fjy/SsNotice/editFile.do?FILEID="+FILEID;
