...
Ext.tree.TreeCheckNodeUI = function() {    
    ...
    this.checkAble=false;//是否允许选择,
    //only leaf can checked    
    //this.onlyLeafCheckable = false;    
    this.isCheckAble =function(n, a, targetNode, bulkRender){
    	return true;//可以选择
    	//return false;//不可以选择
    }
...
Ext.extend(Ext.tree.TreeCheckNodeUI, Ext.tree.TreeNodeUI, {    
    ...
    renderElements : function(n, a, targetNode, bulkRender){    
        ...
        this.checkAble = tree.isCheckable(n, a, targetNode, bulkRender);    
            
        // add some indent caching, this helps performance when rendering a large tree    
        this.indentMarkup = n.parentNode ? n.parentNode.ui.getChildIndent() : '';    
   	
    var cb =  this.checkAble;    
