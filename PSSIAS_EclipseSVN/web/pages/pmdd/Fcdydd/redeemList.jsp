...
<div class="queryPanel">
    <s:form action="/pages/pmdd/Fcdydd/redeemList.do"  theme="simple" style="display: inline;" method="post">
	    <table cellpadding="0" cellspacing="0" border="0" class="tb_all">
		           ...
		           <tr>
			              <td class="tb_bottom" colspan="4">
			                       <input type="submit"  value="查询" onclick="getReferenceForm(this).action='${ctx}/pages/pmdd/Fcdydd/redeemList.do'"/>
...
<ec:table items='page.result' var="item" method="get"
	...
	action="${ctx}/pages/pmdd/Fcdydd/redeemList.do" autoIncludeParameters="true">
	<ec:row>
		...
		<ec:column property="操作" title="操作" sortable="false" viewsAllowed="html">
			...
			<c:if test="${item.sfsh=='1'}">
						<a href="${ctx}/pages/pmdd/Fcdydd/redeemShow.do?dnumber=${item.dnumber}&<mytag:params includes="ec*,s*" type="queryStringUtf"/>">查看</a>&nbsp;&nbsp;&nbsp;
			 </c:if>
			<c:if test="${item.sfsh=='0'}">
			<a href="${ctx}/pages/pmdd/Fcdydd/redeemEdit.do?dnumber=${item.dnumber}&<mytag:params includes="ec*,s*" type="queryStringUtf"/>">赎回</a>
		    </c:if>
		</ec:column>
	</ec:row>
</ec:table>
