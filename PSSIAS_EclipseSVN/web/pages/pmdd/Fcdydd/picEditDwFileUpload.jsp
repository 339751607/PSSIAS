...
<table cellspacing="0" cellpadding="0" border="0" width="100%" class="pg_add">
	<form id="editForm" name="editForm"  action="${ctx}/pages/pmdd/Fcdydd/picDwEdit.do" enctype="multipart/form-data" action="" method="post">
...
function SendFile()
{
   ...
   var   uploadfileidValue = document.getElementById("uploadfileid").value; 
	...
	document.editForm.action="${ctx}/pages/pmdd/Fcdydd/picDwEdit.do?dnumber="+dnumber;
	...
	//document.editForm.submit() ;
      ...
      function selectCapturePhoto(frm,displayName,hiddenName) {
	           window.showModalDialog('${ctx}/pages/FileAttach/selectCapturePhoto.do?formName=' + frm.name + '&inputName='+displayName+'&hiddenName='+hiddenName+'',frm,'dialogHeight:270px;dialogWidth:580px;center:yes');
       }
