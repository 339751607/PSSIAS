...
<div class="queryPanel">
    <s:form action="/pages/pmdd/Fcdydd/list.do"  name="form1" theme="simple" style="display: inline;" method="post">
	    <table cellpadding="0" cellspacing="0" border="0" class="tb_all">
		           ...
		           <tr>
			              <td class="tb_bottom" colspan="4">
			                       <input type="submit"  value="查询" onclick="getReferenceForm(this).action='${ctx}/pages/pmdd/Fcdydd/list.do'"/>
	                               ...
	                               <input type="submit"  value="新增" onclick="getReferenceForm(this).action='${ctx}/pages/pmdd/Fcdydd/create.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>'"/>
...
<ec:table items='page.result' var="item" method="get"
	...
	<ec:row>
			...
			<a href="${ctx}/pages/pmdd/Fcdydd/show.do?dnumber=${item.dnumber}&<mytag:params includes="ec*,s*" type="queryStringUtf"/>">查看</a>&nbsp;&nbsp;&nbsp;
			<c:if test="${item.sfsh=='0'}">
			<a href="${ctx}/pages/pmdd/Fcdydd/edit.do?dnumber=${item.dnumber}&<mytag:params includes="ec*,s*" type="queryStringUtf"/>">修改</a>
		    </c:if>
		 </ec:column>
	</ec:row>
</ec:table>
...
<script>
	  function doDel() {
	        ...
	        if (confirm('确定执行[删除]操作?')){
				...
				input_txt.value = "!/pages/pmdd/Fcdydd/list.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>";
				form.appendChild(input_txt);
		        form.action = '${ctx}/pages/pmdd/Fcdydd/delete.do';
	            form.submit();
	        }
	  }
</script>