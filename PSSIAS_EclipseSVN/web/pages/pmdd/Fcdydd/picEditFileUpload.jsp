...
<table cellspacing="0" cellpadding="0" border="0" width="100%" class="pg_add">
	<form id="editForm" name="editForm"  action="${ctx}/pages/pmdd/Fcdydd/picEdit.do" enctype="multipart/form-data" action="" method="post">
...
function SendFile()
{
   ...
   var   uploadfileidValue = document.getElementById("uploadfileid").value; 
	...
	document.editForm.action="${ctx}/pages/pmdd/Fcdydd/picEdit.do?dnumber="+dnumber;
