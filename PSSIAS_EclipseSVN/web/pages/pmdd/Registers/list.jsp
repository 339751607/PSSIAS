...
<div class="queryPanel">
    <s:form action="/pages/pmdd/Registers/list.do" name="inputForm" theme="simple" style="display: inline;" method="post">
	    <table cellpadding="0" cellspacing="0" border="0" class="tb_all">
		           ...
		           <tr class="crosscolor_tr">
			              ...
			              <td>
				                   <mytag:select  name="s_note"   notEmpty="false"  dictName="gender"/>
		                  </td>
                   </tr>
		           <tr class="crosscolor_tr">
                          <td class="crosscolor_td">
			              ...
			              <td>
			              	<table class="list">
			              		<tr>
			              			...
			              			<td>从</td>
			              			<td>
			              				<input id="d3134" name="s_packagesBegin"  value="${pageRequest.filters.packagesBegin}"   maxlength="0" size="12" class="Wdate" type="text" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'d3144\')}'})"/> 
			              			</td>
			              			<td>到</td>
			              			<td>
			              ...
			              <td>
			              	<table class="list">
			              		<tr>
			              			...
			              			<td>从</td>
			              			<td>
			              				<input id="d3137" name="s_registertimeBegin"  value="${pageRequest.filters.registertimeBegin}"   maxlength="0" size="12" class="Wdate" type="text" onFocus="WdatePicker({dateFmt:'<%=Registers.FORMAT_REGISTERTIME%>',maxDate:'#F{$dp.$D(\'d3147\')}'})"/>
			              			</td>
			              			<td>到</td>
			              			<td>
		           ...
		           <tr>
			              <td class="tb_bottom" colspan="4">
			                       <input type="submit"  value="查询" onclick="getReferenceForm(this).action='${ctx}/pages/pmdd/Registers/list.do'"/>
	                               <input type="submit"  value="新增" onclick="getReferenceForm(this).action='${ctx}/pages/pmdd/Registers/create.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>'"/>
...
<ec:table items='page.result' var="item" method="get"
	...
	action="${ctx}/pages/pmdd/Registers/list.do" autoIncludeParameters="true">
	<ec:row>
		<ec:column property="选择" title="<input type='checkbox' onclick=\"setAllCheckboxState('items',this.checked)\" >" sortable="false" width="3%" viewsAllowed="html">
			<input type="checkbox" name="items" value="unitid=${item.unitid}&"/>
				            ...
				            <mytag:lookupcolumn property="note"  title="<%=Registers.ALIAS_NOTE%>"	cell="net.java.dev.ec.table.view.LookUpCell" dictType="gender" />
		...
		<ec:column property="操作" title="操作" sortable="false" viewsAllowed="html">
			<a href="${ctx}/pages/pmdd/Registers/show.do?unitid=${item.unitid}&<mytag:params includes="ec*,s*" type="queryStringUtf"/>">查看</a>&nbsp;&nbsp;&nbsp;
			<a href="${ctx}/pages/pmdd/Registers/edit.do?unitid=${item.unitid}&<mytag:params includes="ec*,s*" type="queryStringUtf"/>">修改</a>
		</ec:column>
	</ec:row>
</ec:table>
...
<script>
	  function doDel() {
	        ...
	        if (confirm('确定执行[删除]操作?')){
				...
				input_txt.value = "!/pages/pmdd/Registers/list.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>";
				form.appendChild(input_txt);
		        form.action = '${ctx}/pages/pmdd/Registers/delete.do';
	            form.submit();
	        }
	  }
