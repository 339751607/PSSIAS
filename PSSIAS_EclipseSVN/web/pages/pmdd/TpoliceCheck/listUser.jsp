...
<div class="queryPanel">
    <s:form action="/pages/pmdd/TpoliceCheck/listUser.do"  name="form1" theme="simple" style="display: inline;" method="post">
	    <table cellpadding="0" cellspacing="0" border="0" class="tb_all">
			              ...
			              <td colspan="3">
								<table class="list">
			              		<tr>
			              			...
			              			<td>从</td>
			              			<td>
			              				<input id="d3134" name="s_checktimeBegin"  value="${pageRequest.filters.checktimeBegin}"   maxlength="0" size="12" class="Wdate" type="text" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'d3144\')}'})"/>
			              			</td>
			              			<td>到</td>
			              			<td>
		           ...
		           <tr>
			              <td class="tb_bottom" colspan="4">
			                       <input type="submit"  value="查询" onclick="getReferenceForm(this).action='${ctx}/pages/pmdd/TpoliceCheck/listUser.do'"/>
			                       <input type="button" value="清空" onclick="resitData(document.forms.form1);"/>
	                               <input type="submit"  value="新增" onclick="getReferenceForm(this).action='${ctx}/pages/pmdd/TpoliceCheck/createUser.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>'"/>
...
<ec:table items='page.result' var="item" method="get"
	...
	action="${ctx}/pages/pmdd/TpoliceCheck/listUser.do" autoIncludeParameters="true">
	<ec:row>
		...
		<ec:column property="操作" title="操作" sortable="false" viewsAllowed="html">
			...
			<a href="${ctx}/pages/pmdd/TpoliceCheck/tabUser.do?checkid=${item.checkid}&<mytag:params includes="ec*,s*" type="queryStringUtf"/>">检查信息</a>
		</ec:column>
	</ec:row>
</ec:table>
