...
<s:form action="/pages/pmdd/TpoliceCheck/list.do" method="get" theme="simple">
...
<mytag:tab id="orgInfo"  width="100%" height="100%"   >
     <mytag:tabContent url="${ctx}/pages/pmdd/TpoliceCheckinfo/list.do"     param="s_checkid"  paramValue="${model.checkid}"   frameBorder="0" tabType="frame" scrolling="auto" title="检查信息"/>
...
<script>
    ...
    function doBack(){
    	var url="";
    	url =  "${ctx}/pages/pmdd/TpoliceCheck/listUser.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>";
    	location.href = url;
    }
</script>