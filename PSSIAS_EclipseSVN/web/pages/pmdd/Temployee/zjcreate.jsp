...
<s:form action="/pages/pmdd/Temployee/save_zj.do" theme="simple"  enctype="multipart/form-data"  name="inputForm" method="post">
<s:hidden key="npcodehidden" value="451300" />
<s:hidden key="nativeplacehidden"  value="451300"/>
	              ...
	              <tr class="crosscolor_tr">
		                  ...
		                  <td width="20%" rowspan="13">
							        <c:if test="${typecode == 1 && smycode != 1}"> 
							         <IFRAME height="100%" width="100%" name="result" src="${ctx}/pages/pmdd/Temployee/CVR_IDCard_typecode.html"
										align="center" frameBorder="0" marginHeight="0" marginWidth="0"></IFRAME>
							         </c:if>
							        <c:if test="${typecode != 1 && smycode == 1}"> 
							         <IFRAME height="100%" width="100%" name="result" src="${ctx}/pages/pmdd/Temployee/CVR_IDCard_smycode.html"
										align="center" frameBorder="0" marginHeight="0" marginWidth="0"></IFRAME>
							         </c:if>
							        <c:if test="${typecode == 1 && smycode == 1}"> 
							        
							         <IFRAME height="100%" width="100%" name="result" src="${ctx}/pages/pmdd/Temployee/CVR_IDCard.html"
										align="center" frameBorder="0" marginHeight="0" marginWidth="0"></IFRAME>
							         </c:if>
		           ...
		           <tr class="crosscolor_tr">
			              ...
			              <td>
			                <s:select name="prov" id="prov"  value="450000"  onchange="changeprov();" list="provMap" listKey="key" headerValue="请选择..." headerKey=""  listValue="value" theme="simple" label="省市"  emptyOption="false" ></s:select>
                   ...
                   <tr class="crosscolor_tr">
			              ...
			              <td colspan="3">
						          <s:select name="prov2" id="prov2"  value="450000"  onchange="changeprov2();" list="provMap" listKey="key" headerValue="请选择..." headerKey=""  listValue="value" theme="simple" label="省市"  emptyOption="false" ></s:select>
