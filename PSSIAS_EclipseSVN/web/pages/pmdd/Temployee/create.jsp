...
<s:form action="/pages/pmdd/Temployee/save.do" theme="simple"  enctype="multipart/form-data"  name="inputForm" method="post">
	       ...
	       <tr>
				<td colspan="5" class="tb_title"> 
	              ...
	              <tr class="crosscolor_tr">
						...
						<%--</td>
						  <IFRAME height="100%" width="100%" name="result" src="${ctx}/pages/Temployee/CVR_IDCard.html"
							align="center" frameBorder="0" marginHeight="0" marginWidth="0"></IFRAME>
					--%></td>
                   </tr>
		           <tr class="crosscolor_tr">
		           ...
		           <tr class="crosscolor_tr">
			              ...
			              <td>
			                <s:select name="prov" id="prov"  value="130400"  onchange="changeprov();" list="provMap" listKey="key" headerValue="请选择..." headerKey=""  listValue="value" theme="simple" label="省市"  emptyOption="false" ></s:select>
