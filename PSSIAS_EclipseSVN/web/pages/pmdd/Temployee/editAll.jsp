...
<s:form action="/pages/pmdd/Temployee/updateAll.do"  theme="simple" name="inputForm"  method="post">
	...
	<table cellpadding="0" cellspacing="0" border="0" class="tb_all">
	    <input type="hidden" name="returnUrl" value="!/pages/pmdd/Temployee/listAll.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>" />
	        <tr>
	        ...
	        <tr >
					 <td colspan="5" class="tb_bottom">
	                        ...
	                        <input type="button" value="返回" onclick="window.location='${ctx}/pages/pmdd/Temployee/listAll.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>'"/>   
					 </td>
			</tr>
	</table>
</s:form>
