...
<mytag:tab id="orgInfo"  width="100%" height="100%"   >
	 ...
	 <mytag:tabContent url="${ctx}/pages/pmdd/Tempworklog/list.do"  selected="true"   param="s_empcode"  paramValue="${model.empcode}"   frameBorder="0" tabType="frame" scrolling="auto" title="从业记录"/>
</mytag:tab>
</body>
...
<script>
    ...
    function doBack(){
    	var url="";
    	url =  "${ctx}/pages/pmdd/Temployee/listAll.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>";
    	location.href = url;
    }
</script>