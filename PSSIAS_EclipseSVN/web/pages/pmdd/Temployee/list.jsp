    ...
    <s:form action="/pages/pmdd/Temployee/list.do"  theme="simple" name="form1" style="display: inline;" method="post">
	    <table cellpadding="0" cellspacing="0" border="0" class="tb_all">
		           ...
		           <tr class="crosscolor_tr">
		                  ...
		                  <td class="crosscolor_td">
			                      <%=Temployee.ALIAS_CPNAME%>
		                  </td>
			              <td >
		                            <input value="${pageRequest.filters.deptname}"  name="s_deptname"  />
		                  </td>
                   </tr>
                   <authz:authorize   ifNotGranted="ROLE_BUSINESS_OPERATION,ROLE_DEPT_ADMIN">
                    <tr class="crosscolor_tr">
		                  <td class="crosscolor_td">
			                      部门
		                  </td>
		           ...
		           <tr>
			              <td class="tb_bottom" colspan="4">
			                       <input type="submit"  value="查询" onclick="getReferenceForm(this).action='${ctx}/pages/pmdd/Temployee/list.do'"/>			                   
			                       <input type="button" value="清空" onclick="resitData(document.forms.form1);"/>
			                     <authz:authorize ifNotGranted="ROLE_ADMIN,ROLE_HT_ADMIN">
	                               <input type="submit"  value="新增" onclick="getReferenceForm(this).action='${ctx}/pages/pmdd/Temployee/create.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>'"/>
			             		</authz:authorize>
			              </td>
		           </tr>
	    </table>
...
<ec:table items='page.result' var="item" method="get"
	...
	action="${ctx}/pages/pmdd/Temployee/list.do" autoIncludeParameters="true">
	<ec:row>
		                    ...
		                    <ec:column property="deptname"  title="<%=Temployee.ALIAS_CPNAME%>"/>
