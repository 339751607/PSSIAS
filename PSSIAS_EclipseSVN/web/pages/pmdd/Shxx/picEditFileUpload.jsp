...
<table cellspacing="0" cellpadding="0" border="0" width="100%" class="pg_add">
	<form id="editForm" name="editForm"  action="${ctx}/pages/pmdd/Shxx/picEdit.do" enctype="multipart/form-data" action="" method="post">
...
function SendFile()
{
   ...
   var   flag = document.getElementById("flag").value; 
	...
	document.editForm.action="${ctx}/pages/pmdd/Shxx/picEdit.do?dnumber="+dnumber+"&flag="+flag;
