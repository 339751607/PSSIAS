...
<head>
	...
	<link href="${ctx}/widgets/extremecomponents/extremecomponents.css" type="text/css" rel=stylesheet>
	 <SCRIPT LANGUAGE="Javascript" SRC="${ctx}/FusionCharts/FusionCharts.js"></SCRIPT>
...
<div class="queryPanel">
    <s:form action="/pages/pmdd/StaCl/list.do" name="inputForm" theme="simple" style="display: inline;" method="post">
	    <table cellpadding="0" cellspacing="0" border="0" class="tb_all">
	               <tr>
			              <td class="tb_title" colspan="4">车辆质押统计</td>
		           </tr>
		         ...
		         <tr class="crosscolor_tr">
						...
						<table style="border: none;">
							<tr style="border: none;">
								<td style="border: none;">
									<input name="s_groupType" type="radio" value="0" <%if(s_groupType != null && s_groupType.equals("0")){%> checked <%}%> >数据
								</td>
								<td style="border: none;">
									<input type="radio" name="s_groupType" value="1" <%if(s_groupType != null && s_groupType.equals("1")){%> checked <%}%>>饼图
								</td>
								<td style="border: none;">
									<input type="radio" name="s_groupType" value="2" <%if(s_groupType != null && s_groupType.equals("2")){%> checked <%}%>>柱图
								</td>
							</tr>
						</table>	
						</td>
		           ...
		           <tr>
			              <td class="tb_bottom" colspan="4">
			                       <input type="submit"  value="查询" onclick="getReferenceForm(this).action='${ctx}/pages/pmdd/StaCl/list.do'"/>
...
<ec:table items='page.result' var="item" method="get"
	...
	action="${ctx}/pages/StaCl/list.do" autoIncludeParameters="true">
	<ec:row>
		...
		<ec:column property="操作" title="操作" sortable="false" viewsAllowed="html">
			...
			<a href="${ctx}/pages/pmdd/StaCl/list.do?s_deptseq=${item.deptseq}&<mytag:params includes="ec*,s*" type="queryStringUtf"/>">查看</a>&nbsp;&nbsp;&nbsp;
			</c:if> 
