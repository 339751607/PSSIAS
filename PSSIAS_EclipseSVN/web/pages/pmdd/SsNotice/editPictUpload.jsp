...
<body>
<form name="editForm"   action="${ctx}/pages/pmdd/SsNotice/editPict.do" enctype="multipart/form-data" method="post">
...
function SendFile()
{
   ...
   var   FILEID = document.getElementById("FILEID").value;   
	...
	document.editForm.action="${ctx}/pages/pmdd/SsNotice/editPict.do?FILEID="+FILEID;
