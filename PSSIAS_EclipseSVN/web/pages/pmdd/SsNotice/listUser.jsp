...
<div class="queryPanel">
    <s:form action="/pages/pmdd/SsNotice/listUser.do" name="form1" theme="simple" style="display: inline;" method="post">
	    <table cellpadding="0" cellspacing="0" border="0" class="tb_all">
		           ...
		           <tr>
			              <td class="tb_bottom" colspan="4">
			                       <input type="submit"  value="查询" onclick="getReferenceForm(this).action='${ctx}/pages/pmdd/SsNotice/listUser.do'"/>
...
<ec:table items='page.result' var="item" method="get"
	...
	action="${ctx}/pages/pmdd/SsNotice/listUser.do" autoIncludeParameters="true">
	<ec:row>
		...
		<ec:column property="操作" title="操作" sortable="false" viewsAllowed="html">
			<a href="${ctx}/pages/pmdd/SsNotice/showUser.do?noticeid=${item.noticeid}&<mytag:params includes="ec*,s*" type="queryStringUtf"/>">查看</a>&nbsp;&nbsp;&nbsp;
