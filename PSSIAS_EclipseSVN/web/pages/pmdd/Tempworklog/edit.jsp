...
<s:form action="/pages/pmdd/Tempworklog/update.do"  theme="simple" name="inputForm"  method="post">
	<table cellpadding="0" cellspacing="0" border="0" class="tb_all">
	    <input type="hidden" name="returnUrl" value="!/pages/pmdd/Tempworklog/list.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>" />
	        ...
	        <tr>
	              ...
	              <tr class="crosscolor_tr">
			              ...
			              <td>
						           <mytag:select property="%{model.emptype}"   styleClass="required validate-selection"  name="emptype"   notEmpty="false"  dictName="emptype"/>
		                  </td>
                   </tr>
		           <tr class="crosscolor_tr">
                          <td class="crosscolor_td">
	        ...
	        <tr >
					 <td colspan="4" class="tb_bottom">
	                        ...
	                        <input type="button" value="返回" onclick="window.location='${ctx}/pages/pmdd/Tempworklog/list.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>'"/>   
					 </td>
			</tr>
	</table>
</s:form>
