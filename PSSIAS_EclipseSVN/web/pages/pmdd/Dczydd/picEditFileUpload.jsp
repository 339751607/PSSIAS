...
<table cellspacing="0" cellpadding="0" border="0" width="100%" class="pg_add">
	<form id="editForm" name="editForm"  action="${ctx}/pages/pmdd/Dczydd/picEdit.do" enctype="multipart/form-data" action="" method="post">
...
function SendFile()
{
   ...
   // var   uploadfileidValue = document.getElementById("uploadfileid").value; 
	...
	if(newFileValue.value == "" &&　newFileValue.value　== null){
	   alert('请选取上传的文件！');
	   return false;
	}
	
	document.editForm.action="${ctx}/pages/pmdd/Dczydd/picEdit.do?dnumber="+dnumber;
