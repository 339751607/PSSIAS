...
<s:form action="/pages/pmdd/Tlinkmaninfo/update.do"  theme="simple"  method="post">
	<table cellpadding="0" cellspacing="0" border="0" class="tb_all">
	    <input type="hidden" name="returnUrl" value="!/pages/pmdd/Tlinkmaninfo/list.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>" />
