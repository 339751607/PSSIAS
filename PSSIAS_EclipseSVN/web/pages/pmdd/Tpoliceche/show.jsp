...
<s:form action="/pages/pmdd/Tpoliceche/list.do" method="get" theme="simple">
		        ...
		        <tr class="crosscolor_tr">
                      ...
                      <td class="crosscolor_td">
			              ...
			              <td >
		                        ...
		                        <input type="radio" name="xfss" value="0" ${protection == 0?"checked":""}>是
		                        <input type="radio" name="xfss" value="1" ${protection == 1?"checked":""}>否
		                           
		                  </td>
		                 <td colspan="4">
		                 
		                <s:property value="%{model.xfssInput}"/>
		                 </td>  
                   </tr>
                      ...
                      <td class="crosscolor_td">
			              ...
			              <td >
		                        ...
		                        <input type="radio" name="dpyz" value="0" ${protection == 0?"checked":""}>是
		                        <input type="radio" name="dpyz" value="1" ${protection == 1?"checked":""}>否
		                           
		                  </td>
		                 <td colspan="4">
		                 <s:property value="%{model.dpyzInput}"/>
		                 </td>  
                   </tr>
                      ...
                      <td class="crosscolor_td">
			              ...
			              <td >
		                        ...
		                        <input type="radio" name="flfg" value="0" ${protection == 0?"checked":""}>是
		                        <input type="radio" name="flfg" value="1" ${protection == 1?"checked":""}>否
		                           
		                  </td>
		                 <td colspan="4">
		                 <s:property value="%{model.flfgInput}"/>
		                 </td>  
                   </tr>
