...
<head>
	...
	<base href="<%=basePath%>">
	<title><%=Cyry.TABLE_ALIAS%>新增</title>
</head>
<body>
<%@ include file="/commons/messages.jsp" %>

<s:form action="/pages/pmdd/Cyry/save.do" theme="simple"  method="post">
	<table cellpadding="0" cellspacing="0" border="0" class="tb_all">
	    ...
	    <tr class="crosscolor_tr">
		           ...
		           <tr class="crosscolor_tr">
			              ...
			              <td>
						           <input value="${model.rzrq}" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" id="rzrq" name="rzrq"  maxlength="0" class=" Wdate" />
		                  </td>
