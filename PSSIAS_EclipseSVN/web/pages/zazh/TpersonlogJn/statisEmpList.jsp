...
<div class="queryPanel">
    <s:form action="/pages/zazh/TpersonlogJn/statisEmpList.do"  theme="simple" style="display: inline;" method="post">
	    <table width="100%" border="1" bordercolor="#7c8ca7" align="center"  cellPadding="0" cellSpacing="0" class="tb_all">
	              <tr>
			          <td class="tb_title" colspan="2" >从业人员统计</td>
		           </tr>
...
<table id="ec_table"   border="0"  cellspacing="0"  cellpadding="0"  class="tableRegion"  width="100%" >
    ...
    <%
       String cyryStatusInfo = "";
	   List cyryDictList = request.getAttribute("cyryDictList") == null? null : (List)request.getAttribute("cyryDictList");
	   if(cyryDictList!=null && cyryDictList.size()>0){		   
		   for(int i=0; i < cyryDictList.size(); i++){
			   
			   DictItem item = (DictItem)cyryDictList.get(i);			  

			   cyryStatusInfo = cyryStatusInfo + item.getDictid() +",";
    ...
    <%
	   ...
	   if(cyryStatusInfo!=null && !"".equals(cyryStatusInfo)){
		   cyryStatusInfo = cyryStatusInfo.substring(0,cyryStatusInfo.length()-1);
		   codeArray = cyryStatusInfo.split(",");
	   }
...
function startSetValue(){
    ...
    var s =document.getElementById("hidden_starttime").value;
    document.getElementById("s_starttime").value = s;
    
    var e =document.getElementById("hidden_endtime").value;
    document.getElementById("s_endtime").value = e;
}
startSetValue();
</script>
</html>
