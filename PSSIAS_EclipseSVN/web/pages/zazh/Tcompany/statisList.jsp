...
<div class="queryPanel">
    <s:form action="/pages/zazh/Tcompany/statisList.do"  theme="simple" style="display: inline;" method="post">
	    <table width="100%" border="1" bordercolor="#7c8ca7" align="center"  cellPadding="0" cellSpacing="0" class="tb_all">
	              <tr>
			          <td class="tb_title" colspan="2" >企业信息统计</td>
		           </tr>
...
function startSetValue(){
    ...
    var s =document.getElementById("hidden_status").value;
    setCombox("s_status" , s);
}
startSetValue();
</script>
</html>
