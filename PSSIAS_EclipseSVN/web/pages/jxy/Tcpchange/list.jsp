...
<ec:table items='page.result' var="item" method="get"
	...
	action="${ctx}/pages/jxy/Tcpchange/list.do" autoIncludeParameters="true">
	<ec:row>
...
<script>
	  function doDel() {
	        ...
	        if (confirm('确定执行[删除]操作?')){
				...
				input_txt.value = "!/pages/jxy/Tcpchange/list.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>";
				form.appendChild(input_txt);
		        form.action = '${ctx}/pages/jxy/Tcpchange/delete.do';
	            form.submit();
	        }
	  }
</script>
