...
<div class="queryPanel">
    <s:form action="/pages/jxy/ViewJspCpstat/list.do"  name="inputForm" theme="simple" style="display: inline;" method="post">
	    <table cellpadding="0" cellspacing="0" border="0" class="tb_all">
	               <tr>
			              <td class="tb_title" colspan="4"><%=ViewJspCpstat.TABLE_ALIAS%></td>
		           </tr>
		           ...
		           <tr>
			              <td class="tb_bottom" colspan="4">
			                       <input type="submit"  value="统计" onclick="getReferenceForm(this).action='${ctx}/pages/jxy/ViewJspCpstat/list.do'"/>
...
<ec:table items='page.result' var="item" method="get"
	...
	action="${ctx}/pages/jxy/ViewJspCpstat/list.do" 
	...
	<ec:row>
		                    ...
		                    <ec:column property="xsaj"  title="<%=ViewJspCpstat.ALIAS_XSAJ%>" cell="number" format="###,###,##0"  calc="total" calcTitle= "合计"/>
		                    <ec:column property="zaaj"  title="<%=ViewJspCpstat.ALIAS_ZAAJ%>" cell="number" format="###,###,##0"  calc="total" calcTitle= "合计"/>
		                    <ec:column property="jgcs"  title="<%=ViewJspCpstat.ALIAS_JGCS%>" cell="number" format="###,###,##0"  calc="total" calcTitle= "合计"/>
		                    <ec:column property="fmffsd"  title="<%=ViewJspCpstat.ALIAS_FMFFSD%>" cell="number" format="###,###,##0"  calc="total" calcTitle= "合计"/>
		                    <ec:column property="tyzd"  title="<%=ViewJspCpstat.ALIAS_TYZD%>" cell="number" format="###,###,##0"  calc="total" calcTitle= "合计"/>
		                    <ec:column property="zjzr"  title="<%=ViewJspCpstat.ALIAS_ZJZR%>" cell="number" format="###,###,##0"  calc="total" calcTitle= "合计"/>
		                    <ec:column property="qtcf"  title="<%=ViewJspCpstat.ALIAS_QTCF%>" cell="number" format="###,###,##0"  calc="total" calcTitle= "合计"/>
