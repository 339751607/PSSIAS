	...
	<body onload="quickSelectInit()">
		...
		<div class="queryPanel">
			<s:form action="/pages/jxy/Tcpinfo/list.do" name="form1" theme="simple"
				...
				<table cellpadding="0" cellspacing="0" border="0" class="tb_all">
					<tr>
						<td class="tb_title" colspan="4"><%=Tcpinfo.TABLE_ALIAS%>查询
						</td>
					</tr>
					...
					<tr class="crosscolor_tr">
						...
						<td colspan="3">
							<input value="${pageRequest.filters.cpaddress}" size="60"
								name="s_cpaddress" />
						</td>
					</tr>
					<!--  
		           ...
		           <tr class="crosscolor_tr">
					...
					<tr class="crosscolor_tr">
						...
						<td colspan="3" align="left"> 
			                 <table class="list">
			                   <tr>
			                      <td>
							          <s:select name="dateSelect7" list="dateSelectMap"
							        	onchange="dateselect(this,'s_startdateBegin','s_startdateEnd','yyyy-MM-dd');"
							        	value="#request.dateSelect7" listKey="key" listValue="value"
							        	theme="simple" label="" emptyOption="false"></s:select>
							    </td>
							    <td>从</td>
						    	<td>
							      <input id="d3137" name="s_startdateBegin"
							    	value="${pageRequest.filters.startdateBegin}" maxlength="0"
								    size="20" class="Wdate" type="text"
								    onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'d3147\')}'})" />
							   </td>
							   <td>到</td>
							   <td>
							      <input id="d3147" name="s_startdateEnd"
								   value="${pageRequest.filters.startdateEnd}" maxlength="0"
								   size="20" class="Wdate" type="text"
								   onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'d3137\')}'})" />
								</td>
							   </tr>
						     </table>
						</td>
					...
					<tr class="crosscolor_tr">
						...
						<td>
							<mytag:select name="s_economy"
								value="${pageRequest.filters.economy}" notEmpty="false"
								dictName="T_DIC_CPKIND" />
						</td>
						<td class="crosscolor_td">
					...
					<tr class="crosscolor_tr">
						...
						<td>
							<input value="${pageRequest.filters.policename}"
								name="s_policename" />
						</td>
						...
						<td>
							<input value="${pageRequest.filters.scbackupno}"
								name="s_scbackupno" />
						</td>
					</tr>
					<tr class="crosscolor_tr">
						...
						<td>
							<mytag:select name="s_scbackupunit"
								value="${pageRequest.filters.scbackupunit}" notEmpty="false"
								dictName="ssfj" />
						</td>
						<td class="crosscolor_td">
						...
						<td>
							<mytag:select name="s_policeunit"
								value="${pageRequest.filters.policeunit}" notEmpty="false"
								dictName="ssfj" />
						</td>
					</tr>
					<!--  
		           ...
		           <tr class="crosscolor_tr">
					...
					<tr class="crosscolor_tr">
						...
						<td>
							<mytag:select name="s_flag" value="${pageRequest.filters.flag}"
								notEmpty="false" dictName="shiFou" />
						</td>
		...
		<ec:table items='page.result' var="item" method="get"
			...
			<ec:row>
				...
				<ec:column property="startdate" parse="yyyyMMdd" format="yyyy-MM-dd"
					cell="date" title="<%=Tcpinfo.ALIAS_STARTDATE%>" />
				<ec:column property="corpname" title="<%=Tcpinfo.ALIAS_CORPNAME%>" />
				<ec:column property="policename"
