...
<div class="queryPanel">
    <s:form action="/pages/jxy/Tcpinfo/listnsjl.do"  name="form1" theme="simple" style="display: inline;" method="post">
	    <table cellpadding="0" cellspacing="0" border="0" class="tb_all">
		           ...
		           <tr>
			              <td class="tb_bottom" colspan="4">
			                       <input type="submit"  value="查询" onclick="getReferenceForm(this).action='${ctx}/pages/jxy/Tcpinfo/listnsjl.do'"/>
...
<ec:table items='page.result' var="item" method="get"
	...
	action="${ctx}/pages/jxy/Tcpinfo/listnsjl.do" autoIncludeParameters="true">
	<ec:row>
		...
		<ec:column width="30px" property="操作" title="操作" sortable="false" viewsAllowed="html">
			<a href="${ctx}/pages/jxy/Tcpnsjl/list.do?cpcode=${item.cpcode}&cpname=${item.cpname}&<mytag:params includes="ec*,s*" type="queryStringUtf"/>">年审</a>
