...
<script>
	...
	{
	 if(k<4){
		  var tb="<table border='0' id='tb"+k+"' cellspacing='1' cellpadding='5' style='width:100%;margin:0px 0px 1px 0px;' align='center' bgcolor='#ffffff'><tr class='crosscolor_tr' bgcolor='#ffffff'><td width='10%' bgcolor='#ffffff'>附件(小于5M)</td><td width='588' bgcolor='#ffffff'><input type='file' size='55' name='affix' style=' BORDER-TOP: 1px solid #7F9DB9 ;BORDER-LEFT:1px solid #7F9DB9 ;BORDER-RIGHT: 1px solid #7F9DB9 ;BORDER-BOTTOM: 1px solid #7F9DB9 ;' style='400'><input type='button' value='删除附件' style=' BORDER-TOP: 1px solid #7F9DB9 ;BORDER-LEFT:1px solid #7F9DB9;BORDER-RIGHT:1px solid #7F9DB9 ;BORDER-BOTTOM:1px solid #7F9DB9;' onclick=delelteTB('tb"+k+"','FileTable')></td></tr></table>";
