...
<%
String id = request.getParameter("cpempcode");
%>
...
<base target="_self">
<body topMargin="0">
<form id="opeForm" name="opeForm"  action="${ctx}/pages/jxy/Temployee/updatePic.do" enctype="multipart/form-data" action="" method="post">
<table width="100%" border="1" bordercolor="#7c8ca7" align="center" 	cellPadding="0" cellSpacing="0" class="tb_all">
<input type="hidden" name="cpempcode" value="<%=id%>" />
 <tr class="crosscolor_tr">
 <td>
<input type="file" name="file" size="30" cssClass="validate-file-png-jpg-jpeg-gif-bmp">
