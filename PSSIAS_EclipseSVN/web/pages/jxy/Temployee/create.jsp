	       ...
	       <tr>
				<td colspan="5" class="tb_title"> 
	              ...
	              <tr class="crosscolor_tr">
			              ...
			              <td>
	                               <s:textfield label="%{@vs@ALIAS_NAME}" key="name" id="name" value="%{model.name}"  cssClass="required max-length-30 validate-chinese" required="true" />
		                  </td>
                          <td class="crosscolor_td">
			              ...
			              <td>
		                    ...
		                    <td width="25%" rowspan="13"  id="clxxDevice">
		                     <%
			             
			             	if (  smycode.equals("1")&& typecode.equals("1")) {
			             %>    
			              <IFRAME height="200" width="200" name="result"   src="${ctx}/pages/jxy/Temployee/MyHtml.html"
							align="center" frameBorder="0" marginHeight="0" marginWidth="0"></IFRAME>
							
							<IFRAME height="200" width="200" name="result"   src="${ctx}/pages/jxy/Temployee/CVR_IDCard.html"
							align="center" frameBorder="0" marginHeight="0" marginWidth="0"></IFRAME>
			             <%
			             
			             	}if (!smycode.equals("1") && typecode.equals("1")) {
			             %>     
						  <IFRAME height="370" width="200" name="result"   src="${ctx}/pages/jxy/Temployee/MyHtml.html"
							align="center" frameBorder="0" marginHeight="0" marginWidth="0"></IFRAME>
						  <%
						  	} else if (smycode.equals("1") && !typecode.equals("1")) {
						  %>	
							<IFRAME height="370" width="200" name="result"   src="${ctx}/pages/jxy/Temployee/CVR_IDCard.html"
							align="center" frameBorder="0" marginHeight="0" marginWidth="0"></IFRAME>
						  <%
						  	}
						  %>
					       </td>
					      <td width ="200px" rowspan="13"  align="center" id="imgidtd" style="display:none;">
						<img id="imgid"	width="160" height="200" src='${ctx}/images/spacer.gif'"   alt=""  border="0" name="photo">
						</td>
                   </tr>
		           <tr class="crosscolor_tr">
                          <td class="crosscolor_td">
			              ...
			              <td>
	                               <s:textfield label="%{@vs@ALIAS_PERSONID}" id="personid" onblur="javascript:showBirthday();"  key="personid" value="%{model.personid}"  cssClass="required max-length-18 validate-id-number" required="true" />
		                  </td>
                          <td class="crosscolor_td">
			                      <FONT color="red">*</FONT><%=Temployee.ALIAS_BIRTH%>
		                  </td>
			              <td>
			               <input value="${model.birth}" class="required Wdate" size="16" id="birth"
		           ...
		           <tr class="crosscolor_tr">
		                  ...
		                  <td class="crosscolor_td">
			                    <FONT color="red">*</FONT>  <%=Temployee.ALIAS_INDATE%>
		                  </td>
			              <td >
							<input value="${model.indate}" class="required Wdate" size="16" onkeyup="DateFormat(this);" 	onclick="WdatePicker({startDate:'new Date()',dateFmt:'yyyy-MM-dd'})"
							id="indate" name="indate"  />
		                  </td>
                          <td class="crosscolor_td">
		           ...
		           <tr class="crosscolor_tr">
			              ...
			              <td>
						           <mytag:select property="%{model.hyzk}" name="hyzk"   notEmpty="false"  dictName="T_DIC_HYZK"/>
		                  </td>
                   </tr>
		           <tr class="crosscolor_tr">
                          <td class="crosscolor_td">
		           ...
		           <tr class="crosscolor_tr">
			              ...
			              <td colspan="3">
						          <s:select name="prov2" id="prov2"  value="130400"  onchange="changeprov2();" list="provMap" listKey="key" headerValue="请选择..." headerKey=""  listValue="value" theme="simple" label="省市"  emptyOption="false" ></s:select>
                    ...
                    <td class="crosscolor_td">
			              ...
			              <td colspan="3">
			                <s:select name="prov" id="prov" onchange="changeprov();" list="provMap" listKey="key" headerValue="请选择..." headerKey=""  listValue="value" theme="simple" label="省市"  emptyOption="false" ></s:select>
		           ...
		           <tr class="crosscolor_tr">     
			              ...
			              <td colspan="3">
		                           <s:textfield label="%{@vs@ALIAS_NPADDRESS}"  size="60" key="npaddress" id="npaddress" value="%{model.npaddress}"  cssClass="max-length-100" required="false" />
		                  </td>
                   </tr>
		           <tr class="crosscolor_tr">
                          <td class="crosscolor_td">
          		 ...
          		 <tr class="crosscolor_tr">     
			              ...
			              <td colspan="3">
		                           <s:textfield label="%{@vs@ALIAS_NOWADRESS}" size="60" key="nowadress" value="%{model.nowadress}"  cssClass="max-length-100" required="false" />
		                  </td>
                   </tr>
		           <tr class="crosscolor_tr">
