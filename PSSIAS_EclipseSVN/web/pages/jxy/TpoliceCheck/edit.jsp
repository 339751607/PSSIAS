...
<s:form action="/jxy/TpoliceCheck/update.do" name="inputForm" theme="simple"  method="post">
	<table cellpadding="0" cellspacing="0" border="0" class="tb_all">
	    <input type="hidden" name="returnUrl" value="!/jxy/TpoliceCheck/list.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>" />
	        ...
	        <tr >
					 <td colspan="4" class="tb_bottom">
	                        ...
	                        <input type="button" value="返回" onclick="window.location='${ctx}/jxy/TpoliceCheck/list.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>'"/>   
					 </td>
			</tr>
	</table>
</s:form>
