...
<s:form action="/pages/hotel/TchLocal/list.do" method="get" theme="simple">
	...
	<table cellpadding="0" cellspacing="0" border="0" class="tb_all">
                   ...
                   <tr>
						  <td colspan="5" class="tb_bottom">
						           <input type="button" value="返回" onclick="window.location='${ctx}/pages/hotel/TchLocal/list.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>'"/>
	                      </td>
	               </tr>
	</table>	
</s:form>
