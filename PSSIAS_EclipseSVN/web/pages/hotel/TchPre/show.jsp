	...
	<table cellpadding="0" cellspacing="0" border="0" class="tb_all">
	               ...
	               <tr>
						  ...
						  <%
						  		if(existCar){
						  			%>
						           <input type="button" value="车辆信息" onclick='javascript:openNewWindow("${model.id}")' style="margin-right: 20px"/>
						  			<%
						  		}
						  %>
                   ...
                   <tr>
					...
					<ec:table items='page.result' var="item" method="get"
						...
						action="${ctx}/pages/hotel/TchPre/show.do" autoIncludeParameters="true" sortable="false">
						<ec:row>
							...
							<ec:column property="操作" title="操作" sortable="false" viewsAllowed="html">
								<a href="${ctx}/pages/hotel/TchPre/roommatesShow.do?id=${item.id}&roommates=${model.roommates}&<mytag:params includes="ec*,s*" type="queryStringUtf"/>">查看</a>&nbsp;&nbsp;&nbsp;
							</ec:column>
						</ec:row>
					</ec:table>
