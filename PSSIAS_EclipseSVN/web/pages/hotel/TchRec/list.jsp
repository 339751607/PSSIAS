...
<ec:table items='page.result' var="item" method="get"
	...
	<ec:row>
		                    ...
		                    <mytag:lookupcolumn property="idName"  title="<%=TchRec.ALIAS_ID_NAME%>"	cell="net.java.dev.ec.table.view.LookUpCell" dictType="T_ID_NAME" />
		                    <ec:column property="idCode"  title="<%=TchRec.ALIAS_ID_CODE%>"/>
		                    ...
		                    <ec:column property="noRoom"  title="<%=TchRec.ALIAS_NO_ROOM%>"/>
		                    <ec:column property="inTime"  title="<%=TchRec.ALIAS_IN_TIME%>" parse="yyyyMMddHHmm" format="yyyy-MM-dd HH:mm" cell="date"/>
		                    <ec:column property="days"  title="<%=TchPre.ALIAS_DAYS%>"/>
		<ec:column property="操作" title="操作" sortable="false" viewsAllowed="html">
			<a href="${ctx}/pages/hotel/TchRec/show.do?id=${item.id}&<mytag:params includes="ec*,s*" type="queryStringUtf"/>">查看</a>&nbsp;&nbsp;&nbsp;
		</ec:column>
	</ec:row>
</ec:table>
