...
<ec:table items='page.result' var="item" method="get"
	...
	<ec:row>
		                    ...
		                    <ec:column property="chn"  title="<%=TtjGuestType.ALIAS_GUESTCH%>" cell="number" format="###,###,##0"  calc="total" calcTitle= "合计"/>
		                    <ec:column property="jwn"  title="<%=TtjGuestType.ALIAS_GUESTJW%>" cell="number" format="###,###,##0"  calc="total" calcTitle= "合计"/>
		                    <ec:column property="total"  title="<%=TtjGuestType.ALIAS_TOTAL%>" cell="number" format="###,###,##0"  calc="total" calcTitle= "合计"/>
	</ec:row>
</ec:table>
