...
<s:form action="/pages/hotel/TchTrack/list.do" method="get" theme="simple">
	...
	<table cellpadding="0" cellspacing="0" border="0" class="tb_all">
		           ...
		           <tr class="crosscolor_tr">
			              ...
			              <td>
		                           <a href="${ctx}/pages/hotel/Thotel/show.do?code=${model.hotelid}" ><s:property value="%{model.hotelname}" /></a>		                  </td>
                          <td class="crosscolor_td">
