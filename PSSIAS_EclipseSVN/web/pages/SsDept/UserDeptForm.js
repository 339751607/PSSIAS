...
AppUserForm.prototype.setup = function(_title,userId) {
	//var _url = '../SsDept/treelist.do'; user.html <script type="text/javascript" src="../../widgets/ux/TreeSelector.js"></script>
	//var depSelector = new TreeSelector('depTreeSelector', _url, '所属部门','deptid');//使用ss_dept用这个
	...
	var userform = new Ext.form.FormPanel({
				...
				bodyStyle : "margin-top:0px;margin-left:0px;margin-right:0px; background-color: transparent;",
				labelAlign : "right",
				layout : 'table',
				height : 425,
				autoScroll:true,
								...
								items : [{
											...
											handler : function() {
												...
												var dialog = createUploadDialog({
																...
																permitted_extensions:['jpg','jpeg','bmp']
															});
