...
$(function () {
	...
	$("#demo")
		.jstree({ 
			...
			"json_data" : { 
				...
				"ajax" : {
					...
					"url" : "${ctx}/pages/SsDept/getCyryTreeForDeptPerson.do?rootID=<%=rootID%>&deptTypeId=<%=deptTypeId%>",
		...
		.bind("select_node.jstree", function (event, data){
		  ...
		  var nodeTypes = data.rslt.obj.attr("nodeTypes");  
		  if(initPageFlag =="1" && nodeTypes == "person") {
		     addP(name,id,type);
		   }
		   initPageFlag = "1";
		 });
