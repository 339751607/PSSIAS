...
<head>
	...
	<base href="<%=basePath%>">
	<title><%=SsDictItem.TABLE_ALIAS%>编辑</title>
</head>

<body onload="quickSelectInit()" >
<%@ include file="/commons/messages.jsp" %>

<s:form action="/pages/SsDictItem/update.do"  theme="simple"  method="post">
	  <table width="100%" border="1" bordercolor="#7c8ca7" align="center"  cellPadding="0" cellSpacing="0" class="tb_all">
	    <input type="hidden" name="returnUrl" value="!/pages/SsDictItem/list.do?<mytag:params includes="ec*,s*" type="queryStringUtf"/>" />
	      <s:hidden id="dicttypeid" name="dicttypeid" />
	        <tr>
				      <td colspan="4" class="tb_title"> 
							<%=SsDictItem.TABLE_ALIAS%>编辑
				     </td>
		    </tr>
	          <tr class="crosscolor_tr">
			              ...
			              <td>
		                           <s:textfield label="%{@vs@ALIAS_DICTNAME}" key="dictname" value="%{model.dictname}" cssClass="required max-length-255" required="false" />
		                  </td>
                   </tr>
		           <tr class="crosscolor_tr">
                          <td class="crosscolor_td">
