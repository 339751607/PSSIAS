...
<!-- optional javascript: effects.js,jquery.js -->
	...
	<link href="<c:url value="/styles/tb.css"/>" type="text/css" rel="stylesheet">
	<link href="<c:url value="/styles/tgcalendar.css"/>" type="text/css" rel="stylesheet">
...
<script src="<c:url value="/scripts/quickSelect.js"/>" type="text/javascript"></script>
<script src="<c:url value="/scripts/resitData.js"/>" type="text/javascript"></script>
