...
Ext.lingo.JsonGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    buildColumnModel: function() {
        ...
        this.height = Ext.get("layout").getHeight();
...
*/
    ...
    edit : function() {
        ...
        if (this.checkOne()) {
	        ...
	        this.formPanel.form.loadRecord(records[0]);
	       // this.dtlformpanel.url = '../SsRole/extupdate.do';
            this.formPanel.load({    
                url: this.urlLoadData + "?id=" + this.getRecordArrayUtils(records, 'id')
            });
        }
    },
    ...
    createDialog : function() {
        ...
        this.formPanel = new Ext.form.FormPanel({
            ...
            title: '详细信息',
            reader: reader,
            url: this.urlSave+"?nodeId="+getNodeID(),
            items: items,
            buttons: [{
                text: '确定',
                handler: function() {
                this.formPanel.getForm().url=this.urlSave+"?nodeId="+getNodeID();
