...
public abstract class AbstractMethodDefinitionSource implements
	...
	public ConfigAttributeDefinition getAttributes(Object object)
		...
		if (object instanceof MethodInvocation) {
			 System.out.println("方法保护>>>>>>>>>>>>>>> MethodInvocation" );
			MethodInvocation mi = (MethodInvocation)object;
			Method method = mi.getMethod();
			Class targetClass = mi.getThis().getClass();
			System.out.println(" MethodInvocationTarget method Name" + method);
			System.out.println(" MethodInvocationTarget Class Name: " + targetClass);
			return lookupAttributes(method, targetClass);
		}
		if (object instanceof JoinPoint) {
			 System.out.println("方法保护>>>>>>>>>>>>>>> JoinPoint" );
			...
			System.out.println(" MethodInvocationTarget Class: " + targetClazz);
			System.out.println(" MethodInvocationTarget Method Name: " + targetMethodName);
