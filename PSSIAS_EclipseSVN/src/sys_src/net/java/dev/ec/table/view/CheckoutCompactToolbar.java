...
//            UserToolbarBuilder
//退宿工具条
public class CheckoutCompactToolbar extends TwoColumnRowLayout
{

	public CheckoutCompactToolbar(HtmlBuilder html, TableModel model)
    {
        super(html, model);
    }
    ...
    protected void columnRight(HtmlBuilder html, TableModel model)
    {
        ...
        html.td(5).close();
        html.input("button").name(model.getTableHandler().prefixWithTableId() + TableConstants.ROWS_DISPLAYED).value("批量退房").onclick("javascript:doCheckout();");
        html.xclose();
        html.tdEnd();
