...
public class DictWrite extends Component {
	...
	public DictWrite(ValueStack arg0, HttpServletRequest request) {
		super(arg0);
		this.request = request;
	...
	protected String getWriteOptions() throws InstantiationException,
