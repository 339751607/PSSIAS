...
public class TpersonlogJn extends BaseEntity {
	
	//alias
	public static final String TABLE_ALIAS = "境内人员详细信息";
	public static final String ALIAS_ID = "流水号(取值：SEQ_T_PERSONLOG_JN)";
	public static final String ALIAS_PERSONID = "人员ID（对应表T_PERSONBASE_JN的ID）";
	...
	public boolean equals(Object obj) {
		if(obj instanceof TpersonlogJn == false) return false;
		if(this == obj) return true;
		TpersonlogJn other = (TpersonlogJn)obj;
