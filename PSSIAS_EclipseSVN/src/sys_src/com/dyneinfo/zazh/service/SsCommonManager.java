...
import  com.dyneinfo.zazh.dao.SsCommonDao;
import java.io.File;
import java.io.IOException;

@Component
public class SsCommonManager {
	
	private SsCommonDao ssCommonDao;
	
	

	public SsCommonDao getSsCommonDao() {
		return ssCommonDao;
	}
	public void setSsCommonDao(SsCommonDao ssCommonDao) {
