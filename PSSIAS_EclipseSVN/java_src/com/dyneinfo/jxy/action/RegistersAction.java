...
import com.dyneinfo.jxy.model.Registers;
import com.dyneinfo.jxy.service.RegistersManager;
...
public class RegistersAction extends BaseStruts2Action implements Preparable,ModelDriven{
	...
	//forward paths
	protected static final String QUERY_JSP = "/pages/Registers/query.jsp";
	protected static final String LIST_JSP= "/pages/Registers/list.jsp";
	protected static final String CREATE_JSP = "/pages/Registers/create.jsp";
	protected static final String EDIT_JSP = "/pages/Registers/edit.jsp";
	protected static final String SHOW_JSP = "/pages/Registers/show.jsp";
	//redirect paths,startWith: !
	protected static final String LIST_ACTION = "!/pages/Registers/list.do";
	...
	public void setRegistersManager(RegistersManager manager) {
