...
public class tpoliCkAction extends BaseStruts2Action implements Preparable,ModelDriven{
	//默认多列排序,example: username desc,createTime asc
	protected static final String DEFAULT_SORT_COLUMNS = null; 
	
	//forward paths
	protected static final String QUERY_JSP = "/pages/jxy/tpoliCk/query.jsp";
	protected static final String LIST_JSP= "/pages/jxy/tpoliCk/list.jsp";
	protected static final String CREATE_JSP = "/pages/jxy/tpoliCk/create.jsp";
	protected static final String EDIT_JSP = "/pages/jxy/tpoliCk/edit.jsp";
	protected static final String SHOW_JSP = "/pages/jxy/tpoliCk/show.jsp";
	//redirect paths,startWith: !
	protected static final String LIST_ACTION = "!/jxy/tpoliCk/list.do";
	
	private tpoliCkManager tpoliCkManager;
	
	private tpoliCk tpoliCk;
	...
	public void prepare() throws Exception {
		if (isNullOrEmptyString(id)) {
			...
			tpoliCk = (tpoliCk)tpoliCkManager.getById(id);
		}
	}
	
	/** 增加setXXXX()方法,spring就可以通过autowire自动设置对象属性 */
	public void settpoliCkManager(tpoliCkManager manager) {
		this.tpoliCkManager = manager;
	}	
	...
	public void setCheckdate(java.lang.String val) {
		this.id = val;
	}
...
//      pageRequest.getFilters().put("s_inTime_end",tt.getCurrentWeekday());//
	...
	public String list() {
		...
		Page page = tpoliCkManager.findByPageRequest(pageRequest);
	...
	public String update() {
		HttpServletRequest request = ServletActionContext.getRequest();
		tpoliCkManager.update(this.tpoliCk);
		return returnUrl;////LIST_ACTION;
	}
	...
	public String delete() {
		...
		//	tpoliCkId id = (tpoliCkId)copyProperties(tpoliCkId.class,params);
			tpoliCkManager.removeById(id);
		}
		return returnUrl ;//LIST_ACTION;
	}
