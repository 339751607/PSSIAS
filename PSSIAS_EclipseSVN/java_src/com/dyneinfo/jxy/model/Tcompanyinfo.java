...
public class Tcompanyinfo extends BaseEntity {
	...
	public static final String ALIAS_STATIO="所属分局";
	public static final String ALIAS_BASJ = "澶囨鏃堕棿";
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder()
			...
			.append(getStationName(), other.getStationName())
			.isEquals();
	}
}
