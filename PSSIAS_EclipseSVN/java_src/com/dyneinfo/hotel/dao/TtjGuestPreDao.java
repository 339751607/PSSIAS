...
@Component
public class TtjGuestPreDao extends BaseSpringJdbcDao<TtjGuestPre,java.lang.String>{
	
	public Class getEntityClass() {
		return TtjGuestPre.class;
	}
	...
	public void save(TtjGuestPre entity) {
	...
	public void update(TtjGuestPre entity) {
	...
	public Page findByPageRequest(PageRequest<Map> pageRequest,String originSql) {
		// [column]为字符串拼接, {column}为使用占位符. 以下为图方便采用sql拼接,适用性能要求不高的应用,使用占位符方式可以优化性能. 
		// [column] 为PageRequest.getFilters()中的key
		String sql = getSelectPrefix() + getWhereStr(originSql);
		return pageQuery(sql,pageRequest);
	}
	...
	public void savePic(File file, final TtjGuestPre entity) throws IOException {
	...
	public void createTchPre(final TtjGuestPre entity) {
	...
	public void updateTchPre(final TtjGuestPre entity) {
