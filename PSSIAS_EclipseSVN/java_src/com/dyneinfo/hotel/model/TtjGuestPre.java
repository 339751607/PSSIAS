...
public class TtjGuestPre extends BaseEntity {
	
	//alias
	public static final String TABLE_ALIAS = "在住旅客统计";
	...
	public static final String ALIAS_TEL = "前台电话";
	public static final String ALIAS_ROOM_NUM = "房间数";
	public static final String ALIAS_BED_NUM = "床位数";
	public static final String ALIAS_GUEST_NUM = "在住旅客数";
	...
	private java.lang.String guestHotel;
	//columns END
	...
	public boolean equals(Object obj) {
		if(obj instanceof TtjGuestPre == false) return false;
		if(this == obj) return true;
		TtjGuestPre other = (TtjGuestPre)obj;
	...
	public java.lang.String getGuestHotel() {
		return guestHotel;
	}

	public void setGuestHotel(java.lang.String guestHotel) {
