...
public class TchRec extends BaseEntity {
	
	//alias
	public static final String TABLE_ALIAS = "长期住宿";//退宿表
	...
	public static final String ALIAS_CREDIT_CODE = "信用卡类型";
	public static final String ALIAS_CREDIT_NO = "信用卡号码";
	...
	public boolean equals(Object obj) {
		if(obj instanceof TchRec == false) return false;
		if(this == obj) return true;
		TchRec other = (TchRec)obj;
