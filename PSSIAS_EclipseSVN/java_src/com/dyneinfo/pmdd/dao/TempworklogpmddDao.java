...
@Component
public class TempworklogpmddDao extends BaseSpringJdbcDao<Tempworklog,Long>{
	...
	public void save(Tempworklog entity) {
		String sql = "insert into T_EMPWORKLOG " 
			 + " (WORKLOGID,EMPCODE,CPCODE,INDATE,LEFTDATE,EMPTYPE,DEMO,PERSONID,STATUS) " 
			 + " values "
			 + " (:worklogid,:empcode,:cpcode,:indate,:leftdate,:emptype,:demo,:personid,:status)";
	...
	public void update(Tempworklog entity) {
		String sql = "update T_EMPWORKLOG set "
					+ " WORKLOGID=:worklogid,EMPCODE=:empcode,CPCODE=:cpcode,INDATE=:indate,LEFTDATE=:leftdate,EMPTYPE=:emptype,DEMO=:demo,PERSONID=:personid,STATUS=:status "
	...
	public Tempworklog getTemployeeByEmpcade(String empcode){
		String sql=getSelectPrefix()+" where t.empcode= ? and t.status=0";
		...
		getJdbcTemplate().execute(createSql,
				new AbstractLobCreatingPreparedStatementCallback(lobhandler) {
					protected void setValues(PreparedStatement ps,
						...
						ps.setString(8, entity.getPersonid());
