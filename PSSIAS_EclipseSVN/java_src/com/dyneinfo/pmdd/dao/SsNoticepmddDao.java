...
@Component
public class SsNoticepmddDao extends BaseSpringJdbcDao<SsNotice,java.lang.Long>{
	...
	public Page findByPageRequest(String deptID,PageRequest<Map> pageRequest) {
		String query = "select  "
		+" NOTICEID as noticeid,"
		+" NOTICETITLE as noticetitle,"
		+" NOTICECONTENT as noticecontent,"
		...
		+" from SS_NOTICE ";
		String sql = query + " t,SS_dept b ,SS_user c  where t.authorid = c.username and t.sendunitid = b.deptid and b.deptid="+deptID
	...
	public  Page findByPageRequestUser(MyUserDetails userDetail,PageRequest<Map> pageRequest,String arg) {
		...
		return pageQuery1(sql,pageRequest);
	}
