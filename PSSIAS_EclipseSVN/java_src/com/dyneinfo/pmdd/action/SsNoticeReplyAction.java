...
public class SsNoticeReplyAction extends BaseStruts2Action implements Preparable,ModelDriven{
	...
	//forward paths
	protected static final String QUERY_JSP = "/pages/pmdd/SsNoticeReply/query.jsp";
	protected static final String LIST_JSP= "/pages/pmdd/SsNoticeReply/list.jsp";
	protected static final String CREATE_JSP = "/pages/pmdd/SsNoticeReply/create.jsp";
	protected static final String EDIT_JSP = "/pages/pmdd/SsNoticeReply/edit.jsp";
	protected static final String SHOW_JSP = "/pages/pmdd/SsNoticeReply/show.jsp";
	//redirect paths,startWith: !
	protected static final String LIST_ACTION = "!/pages/pmdd/SsNoticeReply/list.do";
	
	private SsNoticeReplypmddManager ssNoticeReplyManager;
	...
	public void setSsNoticeReplypmddManager(SsNoticeReplypmddManager manager) {
...
//      pageRequest.getFilters().put("s_inTime_end",tt.getCurrentWeekday());//
	...
	public String save() {
		...
		if(request.getParameter("pop")!=null){
			return "!/pages/SsNotice/listPop.do?";
		}
		return "!/pages/SsNotice/listUser.do";////LIST_ACTION;
	}
