...
public class ThotelBsQaAction extends BaseStruts2Action implements Preparable,ModelDriven{
	...
	//forward paths
	protected static final String QUERY_JSP = "/pages/pmdd/ThotelBsQa/query.jsp";
	protected static final String LIST_JSP= "/pages/pmdd/ThotelBsQa/list.jsp";
	protected static final String LIST_USER_JSP= "/pages/pmdd/ThotelBsQa/listUser.jsp";
	protected static final String CREATE_JSP = "/pages/pmdd/ThotelBsQa/create.jsp";
	protected static final String EDIT_JSP = "/pages/pmdd/ThotelBsQa/edit.jsp";
	protected static final String SHOW_JSP = "/pages/pmdd/ThotelBsQa/show.jsp";
	protected static final String SHOW_HT_JSP="/pages/pmdd/ThotelBsQa/htshow.jsp";
	//redirect paths,startWith: !
	protected static final String LIST_ACTION = "!/pages/pmdd/ThotelBsQa/list.do";
	
	private ThotelBsQapmddManager thotelBsQaManager;
	...
	public void setThotelBsQapmddManager(ThotelBsQapmddManager manager) {
