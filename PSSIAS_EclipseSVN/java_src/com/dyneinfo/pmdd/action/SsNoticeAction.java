...
import com.dyneinfo.pmdd.service.SsCommonPmddManager;
import com.dyneinfo.pmdd.model.SsNotice;
import com.dyneinfo.pmdd.model.SsNoticeAttend;
import com.dyneinfo.pmdd.service.SsNoticeAttendpmddManager;
import com.dyneinfo.pmdd.service.SsNoticepmddManager;
...
public class SsNoticeAction extends BaseStruts2Action implements Preparable,ModelDriven{
	...
	//forward paths
	protected static final String QUERY_JSP = "/pages/pmdd/SsNotice/query.jsp";
	protected static final String LIST_JSP= "/pages/pmdd/SsNotice/list.jsp";
	protected static final String CREATE_JSP = "/pages/pmdd/SsNotice/create.jsp";
	protected static final String EDIT_JSP = "/pages/pmdd/SsNotice/edit.jsp";
	protected static final String SHOW_JSP = "/pages/pmdd/SsNotice/show.jsp";
	protected static final String SHOW_PIC = "/pages/FileAttach/showPict.jsp";
	protected static final String UPDATEPHOTOERROR = "/pages/pic/updateFileError.jsp";
	//redirect paths,startWith: !
	protected static final String LIST_ACTION = "!/pages/pmdd/SsNotice/list.do";
	
	protected static final String LISTPOP_JSP= "/pages/pmdd/SsNotice/listPop.jsp";
	protected static final String LISTUSER_JSP= "/pages/pmdd/SsNotice/listUser.jsp";
	protected static final String SHOWPOP_JSP = "/pages/pmdd/SsNotice/showPop.jsp";
	protected static final String SHOWUSER_JSP = "/pages/pmdd/SsNotice/showUser.jsp";
	
	private SsNoticepmddManager ssNoticeManager;
	private SsCommonPmddManager ssCommonManager;
	private SsNoticeAttendpmddManager ssNoticeAttendManager;
	...
	public void setSsNoticepmddManager(SsNoticepmddManager manager) {
		this.ssNoticeManager = manager;
	}	
	public void setSsCommonPmddManager(SsCommonPmddManager ssCommonManager) {
		this.ssCommonManager = ssCommonManager;
	}
	public void setSsNoticeAttendpmddManager(SsNoticeAttendpmddManager manager) {
		this.ssNoticeAttendManager = manager;
	}	
	
	public void setFileAttachPmddManager(FileAttachPmddManager manager) {
...
//			pageRequest.getFilters().put("sendunitid", deptID);
		
		Page page = ssNoticeManager.findByPageRequest(deptID,pageRequest);
	...
	public String listUser() {
		...
		if (request.getParameter("dateSelect3") != null)
        	...
        	Page page = ssNoticeManager.findByPageRequestUser(userDetail,pageRequest,null);
		savePage(page,pageRequest);
		return LISTUSER_JSP;
	}
	...
	public String listPop() {
		...
		Page page = ssNoticeManager.findByPageRequestUser(userDetail,pageRequest,"");
		savePage(page,pageRequest);
		return LISTPOP_JSP;
	}
	/** 执行搜索 */
	public String listNotice() throws Exception{
		...
		List list=ssNoticeManager.getByNoticeByUser(userDetail);
	...
	public String show() {
		...
		List orgList = (List) ssCommonManager.getNotice_issuescope(ssNotice.getNoticeid());
		if (orgList != null) {
		...
		//通知 参与人员
		List userList = (List) ssCommonManager.getNotice_participants(ssNotice.getNoticeid());
		if (userList != null) {
		...
		if (noticeid != null && noticeid.length() > 0) {
			List listfile = (List) fileAttachManager.getFile("D","SS_NOTICE_FILE", noticeid, "");
	...
	public String showUser() {
		...
		if (noticeid != null && noticeid.length() > 0) {
			List listfile = (List) fileAttachManager.getFile("D",
					"SS_NOTICE_FILE", noticeid, "");
			request.setAttribute("listfile", listfile);
			int cont=ssNoticeManager.getNoticeReplyById(noticeid,deptid);
			if(cont>0){
...
//        lastDate.add(Calendar.DATE,-1);//减去一天，变为当月最后一天    
        lastDate.set(Calendar.DATE, lastDate.get(Calendar.DATE) + 7);  //一周以后的时间   
