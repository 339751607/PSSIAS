...
public class TpoliceCheckinfoAction extends BaseStruts2Action implements Preparable,ModelDriven{
	...
	//forward paths
	protected static final String QUERY_JSP = "/pages/fjy/TpoliceCheckinfo/query.jsp";
	protected static final String LIST_JSP= "/pages/fjy/TpoliceCheckinfo/list.jsp";
	protected static final String CREATE_JSP = "/pages/fjy/TpoliceCheckinfo/create.jsp";
	protected static final String EDIT_JSP = "/pages/fjy/TpoliceCheckinfo/edit.jsp";
	protected static final String SHOW_JSP = "/pages/fjy/TpoliceCheckinfo/show.jsp";
	//redirect paths,startWith: !
	protected static final String LIST_ACTION = "!/pages/fjy/TpoliceCheckinfo/list.do";
	...
	public void setTpoliceCheckinfoManager(TpoliceCheckinfoManager manager) {
