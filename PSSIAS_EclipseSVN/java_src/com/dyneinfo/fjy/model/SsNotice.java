...
public class SsNotice extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this)
			...
			.append("Issuescope",getIssuescope())
	...
	public int hashCode() {
		return new HashCodeBuilder()
			...
			.append(getNoticecontent())
			.append(getStarttime())
			.append(getEndtime())
			.append(getState())
			.append(getAuthorid())
			.append(getSendunitid())
			.append(getCreatetime())
			.append(getIsreply())
			.append(getIssuescope())
	...
	public boolean equals(Object obj) {
		if(obj instanceof SsNotice == false) return false;
		if(this == obj) return true;
		SsNotice other = (SsNotice)obj;
		return new EqualsBuilder()
			.append(getNoticeid(),other.getNoticeid())
			.append(getNoticetitle(),other.getNoticetitle())
			.append(getNoticecontent(),other.getNoticecontent())
			.append(getStarttime(),other.getStarttime())
			.append(getEndtime(),other.getEndtime())
			.append(getState(),other.getState())
			.append(getAuthorid(),other.getAuthorid())
			.append(getSendunitid(),other.getSendunitid())
			.append(getCreatetime(),other.getCreatetime())
			.append(getIsreply(),other.getIsreply())
			.append(getIssuescope(),other.getIssuescope())
			.append(getParticipants(),other.getParticipants())
